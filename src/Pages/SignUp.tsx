...
import { SignUpInterface } from "../Interfaces/auth.interfaces";
...
export const SignUp = () => {
  ...
  const [userData, setUserData] = useState<SignUpInterface>({
    username: "",
    email: "",
    password: "",
  });
  ...
  const handleChange = (field: keyof SignUpInterface, value: string) => {
